...
tagline = u'能力不够态度补，智商不够时间补。'

# Change this to the description of your blog
description = u'一个刚起步的blog?note?'
...
extensions = [
    'tinkerer.ext.blog', 'tinkerer.ext.disqus',
#    'sphinxcontrib.chinesebeautiful',
]
...
# add by wangyanjie at 2015-10-23
language = 'zh_CN'
